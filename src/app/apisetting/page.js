    ...
    const [messages, setMessages] = useState([
        {
            id: 1,
            role: 'system',
            content: 'API 설계를 시작하겠습니다. 참조할 요구사항을 선택하면 설계를 도와드리겠습니다.'
        }
    ]);
        ...
        <div className="h-screen bg-gray-100 flex">
                                            ...
                                            <CardContent className="p-4">
                                                <div className="flex items-center justify-between mb-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <h3 className="font-medium">{message.suggestion.api_name}</h3>
                                                    </div>
                                                    <button
                                                        onClick={() => {
                                                ...
                                                <div className="space-y-4">
                                                    <pre className="whitespace-pre-wrap break-words">
                                                        {JSON.stringify(message.suggestion.apidata, null, 2)}
                                                    </pre>
                                                </div>
                                            </CardContent>
                                        </Card>
            ...
            <div className="flex-1 flex flex-col bg-gray-50">
                ...
                <div className="p-4 border-b bg-white">
                    <h2 className="text-lg font-semibold">API 설계</h2>
                    <p className="text-sm text-gray-500">총 {datatbales.length}개의 설계</p>
                </div>
